  ...
  public function save(){
    ...
    public function act_login(){
      ...
      public function topup()
      {
        ...
        $data['kota']=$this->Mfrontend->get_all_kota()->result();
        $this->template->load('layout_frontend','frontend/member_topup', $data);
      }

      public function form_topup_add()
      {
        $data['kategori']=$this->Mfrontend->get_all_kategori()->result();
        $this->template->load('layout_frontend','frontend/form_topup_add',$data);
      }
      ...
      public function returbarang()
      {
        ...
        $data['kota']=$this->Mfrontend->get_all_kota()->result();
        $this->template->load('layout_frontend','frontend/member_retur', $data);
      }

      public function form_retur_add()
      {
        $data['kategori']=$this->Mfrontend->get_all_kategori()->result();
        $this->template->load('layout_frontend','frontend/form_retur_add',$data);
      }
      ...
      {
        $data['kategori']=$this->Mfrontend->get_all_kategori()->result();
        $data['produk']=$this->Mmember->get_produk()->result_array();
        $data['kota']=$this->Mfrontend->get_all_kota()->result();
      ...
      {
        $data['kategori']=$this->Mfrontend->get_all_kategori()->result();
        $this->template->load('layout_frontend','frontend/form_profil_edit',$data);
      }
      ...
      public function feedback(){  
        $data['kategori'] = $this -> Mfrontend -> get_all_kategori() -> result();
        $this->template->load('layout_frontend','frontend/feedback', $data);
     }  
