                      ...
                      <ol class="carousel-indicators">
                       ...
                       <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img class="d-block w-100" src="<?php echo base_url('assets/1.jpg');?>" alt="First slide">
          ...
          <h2 class="section-title">Produk</h2>
            ...
            <div class="row">
              <?php foreach($produk as $val) { ?>
                <a href="index.php/member/keranjang">
            ...
            <h2 class="section-title">Produk Selengkapnya</h2>
