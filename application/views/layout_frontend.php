...
<!-- LOGO DI TAMPILAN FRONNT END-->
      <div class="col-1 col-sm-1 offset-sm-0 ">
            <div class="login-brand">
              <img src="<?php echo base_url('assets/Logo_toko.jpg" alt="logo" width="100" class="shadow-light rounded-circle');?>">
            </div>
          </div>


        <a href="<?php echo site_url('memberpanel/home'); ?>" class="navbar-brand sidebar-gone-hide">Z4 Shoes</a>
        ...
        <div class="nav-collapse">
          ...
          <ul class="navbar-nav">
            <li class="nav-item active"><a href="<?php echo site_url('member/about'); ?>" class="nav-link">Tentang Toko Z4 Shoes</a></li>
